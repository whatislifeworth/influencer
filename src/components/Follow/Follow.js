...
const Follow=props=>{
    return(
        <div style={{display:'flex',flexDirection:'column',justifyContent:'flex-end'}} className="pv4 ph3 ph5-ns tc white-80">
                <div style={{color:'black', paddingBottom:'10px',textAlign:'left'}}>FOLLOW US</div>
                <div>
                    ...
                    <a class="link hover-silver near-black dib h2 w2 mr3" href="123" title="Twitter">
